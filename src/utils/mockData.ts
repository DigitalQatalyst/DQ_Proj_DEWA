...
// Categories
export const categories = ["GHC", "Digital", "HoV", "Key Tools", "Day in DQ"];
// Delivery Modes
...
export const mockCourses: CourseType[] = [
  {
    id: "1",
    title: "Vision & Mission: Make It Live",
    description:
      "Learn to connect goals and measurable outcomes back to DQ's vision and mission.",
    category: "GHC",
    deliveryMode: "Hybrid",
    duration: "2 weeks",
    durationType: "Medium",
    ...
    learningOutcomes: [
      "Translate DQ vision statements into practical objectives",
      "Link measurable KPIs to mission pillars",
      "Facilitate goal-setting sessions that drive alignment",
      "Use DQ scorecards to track mission-led progress",
    ],
  ...
  {
    id: "2",
    title: "Agile Essentials (SEDU)",
    description:
      "Master DQ's agile delivery practices for small teams.",
    category: "GHC",
    deliveryMode: "Hybrid",
    duration: "3 weeks",
    durationType: "Medium",
    ...
    learningOutcomes: [
      "Run DQ sprint ceremonies with confidence",
      "Break down work into actionable stories and tasks",
      "Measure flow and health with DQ agile dashboards",
      "Embed continuous improvement in every iteration",
    ],
  ...
  {
    id: "3",
    title: "Communicate to Collaborate",
    description:
      "Build structured, confident communication that elevates teamwork.",
    category: "GHC",
    deliveryMode: "Online",
    duration: "1 week",
    durationType: "Short",
    ...
    learningOutcomes: [
      "Plan clear updates using DQ storytelling templates",
      "Facilitate collaboration rituals that invite every voice",
      "Turn feedback into action plans during retrospectives",
      "Adapt communication styles for hybrid and async teams",
    ],
  ...
  },
  {
    ...
    description:
      "Understand dashboards and data storytelling across DQ projects.",
    category: "Digital",
    deliveryMode: "Online",
    duration: "2 weeks",
    durationType: "Medium",
    ...
    learningOutcomes: [
      "Read common DQ dashboards with confidence",
      "Spot trends and anomalies across squads and units",
      "Build simple data narratives for leadership playback",
      "Apply data ethics and governance in daily decisions",
    ],
  ...
  {
    id: "5",
    title: "Key Tools: Azure DevOps + Git Basics",
    description:
      "Learn DQ's essential tools for versioning and delivery.",
    category: "Key Tools",
    deliveryMode: "Hybrid",
    duration: "2 weeks",
    durationType: "Medium",
    ...
    learningOutcomes: [
      "Set up and manage Azure DevOps boards and repos",
      "Apply Git branching strategies used across DQ",
      "Integrate CI/CD checks for release confidence",
      "Collaborate on pull requests with quality guardrails",
    ],
    startDate: "July 29, 2024",
    price: "Included",
    location: "DQ Tech Lab, Abu Dhabi",
  },
  {
    id: "6",
    title: "AI for Content: NotebookLM & Pods",
    description:
      "Create internal explainers and podcasts using AI.",
    category: "Digital",
    deliveryMode: "Online",
    duration: "1 week",
    durationType: "Short",
    ...
    provider: providers[2],
    learningOutcomes: [
      "Draft explainers with NotebookLM grounded in DQ sources",
      "Design podcast outlines using AI co-creation prompts",
      "Review AI outputs for compliance and factual integrity",
      "Publish assets using DQ asset governance workflows",
    ],
  ...
  {
    id: "7",
    title: "Customer Journeys & Value Streams",
    description:
      "Map and improve experiences using DQ's HoV framework.",
    category: "HoV",
    ...
    provider: providers[1],
    learningOutcomes: [
      "Facilitate HoV journey-mapping workshops",
      "Link journey insights to value stream metrics",
      "Prioritize ATP items that unblock customer outcomes",
      "Build clear improvement backlogs with squads",
    ],
    startDate: "August 12, 2024",
    price: "Included",
    location: "DQ Collaboration Hub",
  },
  {
    id: "8",
    title: "Finance for Non-Finance",
    description:
      "Manage budgets and read reports like a business partner.",
    category: "HoV",
    deliveryMode: "Hybrid",
    duration: "3 weeks",
    durationType: "Medium",
    ...
    provider: providers[0],
    learningOutcomes: [
      "Interpret DQ financial dashboards and reports",
      "Build rolling forecasts for squads and initiatives",
      "Apply cost stewardship practices in delivery plans",
      "Create concise financial updates for leaders",
    ],
  ...
  {
    id: "9",
    title: "Compliance & Legal Basics",
    description:
      "Operate safely within DQ's governance model.",
    category: "HoV",
    deliveryMode: "Online",
    duration: "2 weeks",
    durationType: "Medium",
    ...
    provider: providers[3],
    learningOutcomes: [
      "Navigate DQ compliance and legal guardrails",
      "Apply approval workflows for key deliverables",
      "Recognize data handling and confidentiality requirements",
      "Escalate issues using the right DQ channels",
    ],
  ...
  {
    id: "10",
    title: "HR for Managers",
    description:
      "Lead teams with clarity and fairness in DQ's culture.",
    category: "Day in DQ",
    deliveryMode: "Hybrid",
    duration: "3 weeks",
    durationType: "Medium",
    ...
    provider: providers[4],
    learningOutcomes: [
      "Run DQ performance and growth conversations",
      "Apply talent mobility and recognition policies",
      "Support wellbeing through proactive interventions",
      "Document decisions using DQ people platforms",
    ],
    startDate: "September 2, 2024",
    price: "Included",
    location: "DQ Campus, Abu Dhabi",
  },
  {
    id: "11",
    title: "Strategic Marketing Fundamentals",
    description:
      "Learn positioning and storytelling for internal and external initiatives.",
    category: "HoV",
    deliveryMode: "Online",
    duration: "3 weeks",
    durationType: "Medium",
    ...
    provider: providers[2],
    learningOutcomes: [
      "Craft narratives anchored in DQ value propositions",
      "Plan launch playbooks across internal channels",
      "Measure engagement using DQ comms dashboards",
      "Create assets aligned with brand and tone guidelines",
    ],
  ...
  },
  {
    ...
    title: "A Day in DQ",
    description:
      "Orientation to DQ's tools, rituals, and collaboration norms.",
    category: "Day in DQ",
    deliveryMode: "In-person",
    duration: "1 day",
    durationType: "Short",
    ...
    provider: providers[0],
    learningOutcomes: [
      "Navigate core DQ platforms and workspaces",
      "Join key rituals with confidence and context",
      "Understand how squads, chapters, and communities connect",
      "Build your support network across DQ from day one",
    ],
    startDate: "Every Monday",
    price: "Included",
    location: "DQ Welcome Centre",
  },
];
